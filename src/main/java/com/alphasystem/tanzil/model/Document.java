...
public class Document {
     ...
     * 
     */
    public List<Chapter> getSura() {
        if (sura == null) {
            sura = new ArrayList<Chapter>();
        }
        return this.sura;
    }

    public Document withSura(Chapter... values) {
        if (values!= null) {
    ...
    public Document withSura(Collection<Chapter> values) {
        if (values!= null) {
     ...
     *     
     */
    public void setSura(List<Chapter> sura) {
        this.sura = sura;
    }
